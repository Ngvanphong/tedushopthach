...
namespace DamvayShop.Web.App_Start
{
    ...
    {
        public ApplicationUserStore(DamvayShopDbContext context)
            : base(context)
        {
        }
    }
    public class ApplicationRoleManager : RoleManager<AppRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<AppRole>(context.Get<DamvayShopDbContext>()));
        }
    }
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<DamvayShopDbContext>()));
